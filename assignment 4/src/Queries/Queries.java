...
//    }
//
//    public static String updateTicketAmountForAll() {
//        return "UPDATE tickets SET ticket_amount = ? WHERE time LIKE ?";
//    }
//
...
//        return "UPDATE tickets SET price = ?, time = ?, ticket_amount = ? WHERE ticket_id = '" + ticket_id + "'";
//    }
//
//    public static String deleteTicket(int id) {
//        return "DELETE FROM tickets WHERE ticket_id = " + id;
//    }
//
...
//    }
//
//    public static String updateUserBalance(int id) {
//        return "UPDATE users SET balance = ? WHERE user_id = " + id;
//    }
//}